...
function get(x){
  ...
  //CHANGE THE NAMES OF THE GAMES HERE
    var game1Title = get("answerOne").innerHTML = "He, She, and It!";
...
function appName() {get("boxTwo").innerHTML = "IsEaId";}

function gameTitle() {get("startButton").innerHTML = "Let's Get to Id!";}
...
//This loads the names of the games
    ...
    var mascIlle = [["is ", "this (Subject) "], ["eius ","of that "], ["eī ", "to/for this "], ["eum ", "that (Direct Object) "], ["eō ", "from/with/by/in this "], ["is ", "that (Subject) "], ["eius ","of that "], ["eī ", "to/for this "], ["eum ", "that (Direct Object) "], ["eō ", "from/with/by/in this "]];

    var femIlla = [["ea ", "that (Subject) "], ["eius ","of this "], ["eī ", "to/for that "], ["eam ", "this (Direct Object) "], ["eā ", "from/with/by/in this "], ["ea ", "this (Subject) "], ["eius ","of that "], ["eī ", "to/for that "], ["eam ", "this (Direct Object) "], ["eā ", "from/with/by/in that "]];

    var neutIllud = [["id ", "this (Subject) "], ["eius ","of that "], ["eī ", "to/for this "], ["id ", "that (Direct Object) "], ["eō ", "from/with/by/in this "], ["id ", "that (Subject) "], ["eius ","of that "], ["eī ", "to/for this "], ["id ", "that (Direct Object) "], ["eō ", "from/with/by/in this "]];


    var mascIllePlural = [["eī ", "these (Subject) "], ["eōrum ","of those "], ["eīs (Dative) ", "to/for these "], ["eōs ", "these (Direct Object) "], ["eīs (Ablative) ", "from/with/by/in those "], ["eī ", "these (Subject) "], ["eōrum ","of those "], ["eīs (Dative) ", "to/for these "], ["eōs ", "these (Direct Object) "], ["eīs (Ablative) ", "from/with/by/in those "]];

    var femIllaPlural = [["eae ", "those (Subject) "], ["eārum ","of these "], ["eīs (Dative) ", "to/for those "], ["eās ", "those (Direct Object) "], ["eīs (Ablative) ", "from/with/by/in these "], ["eae ", "those (Subject) "], ["eārum ","of these "], ["eīs (Dative) ", "to/for those "], ["eās ", "those (Direct Object) "], ["eīs (Ablative) ", "from/with/by/in these "]];

    var neutIlludPlural = [["ea (Nominative) ", "these (Subject) "], ["eōrum ","of the those "], ["eīs (Dative) ", "to/for these "], ["ea (Accusative) ", "these (Direct Object) "], ["eīs (Ablative) ", "from/with/by/in those "], ["ea (Nominative) ", "these (Subject) "], ["eōrum ","of the those "], ["eīs (Dative) ", "to/for these "], ["ea (Accusative) ", "these (Direct Object) "], ["eīs (Ablative) ", "from/with/by/in those "]];
    ...
    mascIlle = [["is ", "this (Subject) "], ["eius ","of this "], ["eī ", "to/for this "], ["eum ", "this (Direct Object) "], ["eō ", "from/with/by/in this "], ["is ", "that (Subject) "], ["eius ","of that "], ["eī ", "to/for that "], ["eum ", "that (Direct Object) "], ["eō ", "from/with/by/in that "]];

    femIlla = [["ea ", "this (Subject) "], ["eius ","of this "], ["eī ", "to/for this "], ["eam ", "this (Direct Object) "], ["eā ", "from/with/by/in this "], ["ea ", "that (Subject) "], ["eius ","of that "], ["eī ", "to/for that "], ["eam ", "that (Direct Object) "], ["eā ", "from/with/by/in that "]];

    neutIllud = [["id ", "this (Subject) "], ["eius ","of this "], ["eī ", "to/for this "], ["id ", "this (Direct Object) "], ["eō ", "from/with/by/in this "], ["id ", "that (Subject) "], ["eius ","of that "], ["eī ", "to/for that "], ["id ", "that (Direct Object) "], ["eō ", "from/with/by/in that "]];


    mascIllePlural = [["eī ", "these (Subject) "], ["eōrum ","of those "], ["eīs (Dative) ", "to/for these "], ["eōs ", "these (Direct Object) "], ["eīs (Ablative) ", "from/with/by/in those "], ["eī ", "these (Subject) "], ["eōrum ","of those "], ["eīs (Dative) ", "to/for these "], ["eōs ", "these (Direct Object) "], ["eīs (Ablative) ", "from/with/by/in those "]];

    femIllaPlural = [["eae ", "those (Subject) "], ["eārum ","of these "], ["eīs (Dative) ", "to/for those "], ["eās ", "those (Direct Object) "], ["eīs (Ablative) ", "from/with/by/in these "], ["eae ", "those (Subject) "], ["eārum ","of these "], ["eīs (Dative) ", "to/for those "], ["eās ", "those (Direct Object) "], ["eīs (Ablative) ", "from/with/by/in these "]];

    neutIlludPlural = [["ea (Nominative) ", "these (Subject) "], ["eōrum ","of the those "], ["eīs (Dative) ", "to/for these "], ["ea (Accusative) ", "these (Direct Object) "], ["eīs (Ablative) ", "from/with/by/in those "], ["ea (Nominative) ", "these (Subject) "], ["eōrum ","of the those "], ["eīs (Dative) ", "to/for these "], ["ea (Accusative) ", "these (Direct Object) "], ["eīs (Ablative) ", "from/with/by/in those "]];
